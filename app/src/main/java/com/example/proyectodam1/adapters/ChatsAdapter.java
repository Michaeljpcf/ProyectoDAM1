...
public class ChatsAdapter extends FirestoreRecyclerAdapter<Chat, ChatsAdapter.ViewHolder> {
    ...
    private void getMessagesNotRead(final ViewHolder holder, final String idChat) {
        messagesProvider.getReceiverMessageNotRead(idChat, authProvider.getId()).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot querySnapshot, @Nullable FirebaseFirestoreException error) {
                if (querySnapshot != null) {
                    ...
                    if (size > 0) {
                        ...
                        holder.textViewTimestamp.setTextColor(context.getResources().getColor(R.color.colorAccent));
                    }
                    else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            textViewLastMessage = view.findViewById(R.id.tvLastMensage);
            ...
            textViewMessagesNotRead = view.findViewById(R.id.tvMessagesNotRead);
            textViewWriting = view.findViewById(R.id.tvWriting);
